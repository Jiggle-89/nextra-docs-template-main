...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_js_page_2Fmiddleware_rootDir_C_3A_5CUsers_5Casaf6_5CDesktop_5COffice_20work_5Cdocumentation_5Cnextra_docs_template_main_matchers_preferredRegion_middlewareConfig_e30_3D_)
});
...
var add_path_prefix = __webpack_require__(499);
// EXTERNAL MODULE: ./node_modules/next/dist/esm/shared/lib/router/utils/parse-path.js
var parse_path = __webpack_require__(781);
...
// EXTERNAL MODULE: ./node_modules/next/dist/esm/shared/lib/router/utils/add-locale.js
var add_locale = __webpack_require__(413);
...
function formatNextPathnameInfo(info) {
    let pathname = (0,add_locale/* addLocale */.b)(info.pathname, info.locale, info.buildId ? undefined : info.defaultLocale, info.ignorePrefix);
...
var path_has_prefix = __webpack_require__(158);
...
const addLocale = function(path) {
    ...
    if (true) {
        return normalizePathTrailingSlash((__webpack_require__(413)/* .addLocale */ .b)(path, ...args));
    }
    return path;
...
function removeLocale(path, locale) {
    if (true) {
        const { pathname } = (0,parse_path/* parsePath */.c)(path);
...
;// CONCATENATED MODULE: ./node_modules/nextra/dist/locales.mjs
// src/locales.ts
...
function locales(request) {
    ...
    if (locale) {
        ...
        if (finalLocale !== nextUrl.defaultLocale) {
            const url = addBasePath(addLocale(`${nextUrl.pathname}${nextUrl.search}`, finalLocale, nextUrl.defaultLocale));
    ...
    if (!pathname.endsWith("." + finalLocale)) {
        const url = addBasePath(addLocale(`${pathname}.${finalLocale}${nextUrl.search}`, finalLocale, nextUrl.defaultLocale));
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.js&page=%2Fmiddleware&rootDir=C%3A%5CUsers%5Casaf6%5CDesktop%5COffice%20work%5Cdocumentation%5Cnextra-docs-template-main&matchers=&preferredRegion=&middlewareConfig=e30%3D!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_js_page_2Fmiddleware_rootDir_C_3A_5CUsers_5Casaf6_5CDesktop_5COffice_20work_5Cdocumentation_5Cnextra_docs_template_main_matchers_preferredRegion_middlewareConfig_e30_3D_(opts) {
          return adapter({
            ...opts,
            page: "/middleware",
            handler,
...
/* harmony export */   b: () => (/* binding */ addLocale)
/* harmony export */ });
/* harmony import */ var _add_path_prefix__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(499);
/* harmony import */ var _path_has_prefix__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(158);
 ...
 */ function addLocale(path, locale, defaultLocale, ignorePrefix) {
    ...
    if (!ignorePrefix) {
        if ((0,_path_has_prefix__WEBPACK_IMPORTED_MODULE_0__/* .pathHasPrefix */ .Y)(lower, "/api")) return path;
        if ((0,_path_has_prefix__WEBPACK_IMPORTED_MODULE_0__/* .pathHasPrefix */ .Y)(lower, "/" + locale.toLowerCase())) return path;
    }
    // Add the locale prefix to the path.
    return (0,_add_path_prefix__WEBPACK_IMPORTED_MODULE_1__/* .addPathPrefix */ .V)(path, "/" + locale);
} //# sourceMappingURL=add-locale.js.map
...
/* harmony export */ });
/* harmony import */ var _parse_path__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(781);
...
/******/ var __webpack_exports__ = (__webpack_exec__(709));
