...
var nextVersion = Number(next_package_json__WEBPACK_IMPORTED_MODULE_9__/* .version */ .i8.split(".")[0]);
...
function normalizePages({
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    if (display === "hidden" && item.kind !== "Folder" || _constants_mjs__WEBPACK_IMPORTED_MODULE_1__/* .ERROR_ROUTES */ .hV.has(a.route)) {
      continue;
    }
